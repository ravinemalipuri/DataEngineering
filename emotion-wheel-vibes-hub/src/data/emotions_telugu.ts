    ...
    level2Emotions: [
      {
        ...
        level3Emotions: [
          { id: 'aroused', nameTelugu: 'రెచ్చిపోవుట ' },
      ...
      },
      {
        ...
        level3Emotions: [
          { id: 'successful', nameTelugu: 'విజయవంతమైన' },
      ...
      },
      {
        ...
        level3Emotions: [
          ...
          { id: 'inspired', nameTelugu: 'ప్రేరణ పొందిన ' }
        ]
      }
    ]
  },
    ...
    level2Emotions: [
      ...
      },
      {
        ...
        level3Emotions: [
          ...
          { id: 'revolted', nameTelugu: 'తిరుగుబాటు' }
        ]
      },
      {
        id: 'awful',
  ...
  },
  {
    ...
    level2Emotions: [
      ...
      },
      {
        ...
        nameTelugu: 'దూరం',
        level3Emotions: [
          { id: 'withdrawn', nameTelugu: 'ఉపసంహరించుకోవడం ' },
    ...
    level2Emotions: [
      ...
      },
      {
        ...
        level3Emotions: [
          ...
          { id: 'out-of-control', nameTelugu: 'అదుపు తప్పిన ' }
        ]
      },
      {
        id: 'tired',
    ...
    level2Emotions: [
      {
        ...
        nameTelugu: 'స్టార్డ్',
        level3Emotions: [
          { id: 'shocked', nameTelugu: 'ఆశ్చర్యము' },
      ...
      },
      {
        ...
        level3Emotions: [
          ...
          { id: 'perplexed', nameTelugu: 'కలవరపడడం ' }
        ]
      },
      {
        id: 'amazed',
        nameTelugu: 'విస్మయo',
        level3Emotions: [
          { id: 'astonished', nameTelugu: 'అబ్బురపడు' },
      ...
      },
      {
        ...
        level3Emotions: [
          ...
          { id: 'energetic', nameTelugu: 'శక్తివంతంమైన ' }
        ]
      }
    ]
  }
