"""
Backward-compatible shim that forwards to move_src_to_bronze.
"""

from __future__ import annotations

from .move_src_to_bronze import main
...
from framework.config_loader import ComputeResolver, ConfigLoader, PathBuilder
from framework.dq_engine import DataQualityEngine
from framework.load_strategy import LoadStrategyExecutor
from framework.metadata_repository import MetadataRepository
from framework.models import IngestionResult
from framework.notifications import EmailNotifier
from framework.observability import ObservabilityRecorder
from framework.schema_manager import SchemaManager
from framework.source_reader import SourceReader
...
def run_pipeline(args):
    ...
    path_builder = PathBuilder(cfg.storage_paths())
    ...
    clean_df.write.mode("overwrite").format(cfg.storage_paths()["landing_format"]).save(landing_path)
