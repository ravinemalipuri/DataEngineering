...
(1, 1, 'DB2.CUSTOMER', 'BRONZE', 'Tables/DB2/CUSTOMER',
 ...
 NULL, 1, 'Customer Ops', 'cust.ops@contoso.com',
 'DB2 Squad', 'db2.support@dataplatform.com', '["db2.support@dataplatform.com"]',
 SYSUTCDATETIME(), SYSUTCDATETIME()),
(2, 2, 'SALESFORCE.ACCOUNT', 'SILVER', 'Tables/SF/ACCOUNT',
 'FULL', 'NONE', NULL, NULL,
 1, 0, 'WARN', 'LANDING_ZONE', NULL, 'Full refresh nightly',
 NULL, 1, 'CRM Owners', 'crm.owners@contoso.com',
 'CRM Squad', 'crm.support@dataplatform.com', '["crm.support@dataplatform.com"]',
 SYSUTCDATETIME(), SYSUTCDATETIME());
